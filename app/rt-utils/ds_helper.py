# IMPORTANT - 06/06/2023
# This is an edited version of the ds_helper.py file from rt-utils used as a temporary workaround until rt-utils issues
# a new PyPI release. The edit to this file enables 10 decimal place rounding of the ContourData DICOM element. This
# file is copied and replaces the equivalent file within the MAP Python virtual environment.
#
# Also explained here: https://github.com/GSTT-CSC/TotalSegmentator-AIDE/issues/31
